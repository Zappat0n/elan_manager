...
public class PDFForm_Reports {
    ...
    protected final Integer studentId;
    ...
    protected PDFForm_Reports(BDManager bdManager, CacheManager cacheManager, SettingsManager settingsManager, Connection co,
                              String reportType, Integer studentId, Integer classroom, java.util.Date reportDate,
                              java.util.Date changeDate, BufferedImage logo) {
        this.logo = logo;
