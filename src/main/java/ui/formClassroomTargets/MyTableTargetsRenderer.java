...
public class MyTableTargetsRenderer extends JLabel implements TableCellRenderer {
    /*JList<String>
    ...
    public MyTableTargetsRenderer(CacheManager cacheManager) {
