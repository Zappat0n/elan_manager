 ...
 */
public class TablePresentations_indirect_targets extends MyTable {
    private static final String table_name = "Presentations_indirect_targets";
    ...
    public TablePresentations_indirect_targets() {
